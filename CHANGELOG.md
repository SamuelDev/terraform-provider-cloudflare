...
* chore: point to next ([7bbedc2](https://github.com/cloudflare/terraform-provider-cloudflare/commit/7bbedc22653292a4e41ce7f4c56e9020e78f0d5b))
* docs: WC-4152 Expose subdomain delete for workers ([a9b59cd](https://github.com/cloudflare/terraform-provider-cloudflare/commit/a9b59cd3fc9f12ed83d32418f5e2ed9c3be738f3))
* feat: Add token validation to stainless config ([cc92c74](https://github.com/cloudflare/terraform-provider-cloudflare/commit/cc92c74cb407cb7844d30639b0e570b15e17a2b9))
* feat(api): AGW-83: enable mcp portals terraform generation ([464eef7](https://github.com/cloudflare/terraform-provider-cloudflare/commit/464eef7a0509cd9bc1309fac06a27e7a862dc01f))
* feat(iam): Add SSO Connectors resource to SDKs ([d8ae067](https://github.com/cloudflare/terraform-provider-cloudflare/commit/d8ae067948b0e77fe1b3a72ad2cf9fcacdd9255b))
* feat(mcp_portals): enable sdks generation ([d842873](https://github.com/cloudflare/terraform-provider-cloudflare/commit/d84287392bf16eaaaef29b41f060cc27c964a56d))
* fix: Correctly reflect schema validation model &lt;-&gt; openapi mapping ([de33ee4](https://github.com/cloudflare/terraform-provider-cloudflare/commit/de33ee482de4eac551bf1a01848c5c64857698ce))
* fix: move wvpc ([6fbe259](https://github.com/cloudflare/terraform-provider-cloudflare/commit/6fbe2591bddfcce1a6f3bb27e39781eb382614f3))
* fix(ai_controls): incorrect use of standalone_api ([a578d55](https://github.com/cloudflare/terraform-provider-cloudflare/commit/a578d552b3c698d728e6757c216d581867bdeada))
* mathew/DLS-12780 - Enabling universal_ssl_setting in terraform ([08a3b8c](https://github.com/cloudflare/terraform-provider-cloudflare/commit/08a3b8cc2360b0a59d5e9b66743a011cfb57b349))


### Bug Fixes

* remove failing zero_trust_dex_test and workers_script from next ([#6410](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6410)) ([a28bb20](https://github.com/cloudflare/terraform-provider-cloudflare/commit/a28bb206e04ddd2092174600a2fc738fd2195c98))
* zero_trust_dex_test schema ([#6412](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6412)) ([1ac3faa](https://github.com/cloudflare/terraform-provider-cloudflare/commit/1ac3faa366f47bf98dae12033be1f301923025a7))


### Chores

* **api:** update composite API spec ([5f728e9](https://github.com/cloudflare/terraform-provider-cloudflare/commit/5f728e9aefed0db8ccc96575cec3d26d61b37afd))
* **api:** update composite API spec ([93714e9](https://github.com/cloudflare/terraform-provider-cloudflare/commit/93714e97d5333760238f3598fa92bf9533abb44c))
* **api:** update composite API spec ([767f2dc](https://github.com/cloudflare/terraform-provider-cloudflare/commit/767f2dce6ca768635ad4f92f19c6e3f68a945410))
* **api:** update composite API spec ([19a5315](https://github.com/cloudflare/terraform-provider-cloudflare/commit/19a5315155320478a87a5ddd6bdb4a1b96304828))
* **api:** update composite API spec ([0e9a849](https://github.com/cloudflare/terraform-provider-cloudflare/commit/0e9a849f3eba55af8ef5c8633122c4e8d5cef6da))
* **api:** update composite API spec ([885b1d0](https://github.com/cloudflare/terraform-provider-cloudflare/commit/885b1d0388468a1fc9882a6d8ead21d0c7a91249))
* **api:** update composite API spec ([64f7dc8](https://github.com/cloudflare/terraform-provider-cloudflare/commit/64f7dc8d4bcc39d501cdd65d64d5bc0133cb1931))
* **api:** update composite API spec ([313ae09](https://github.com/cloudflare/terraform-provider-cloudflare/commit/313ae09f106066dadea7d30ff455ff2c55fb32be))
* **api:** update composite API spec ([0c26b4d](https://github.com/cloudflare/terraform-provider-cloudflare/commit/0c26b4d97376da62327b0a8cc05cbe5bd3f76c21))
* **api:** update composite API spec ([b36010f](https://github.com/cloudflare/terraform-provider-cloudflare/commit/b36010f6526d2148cb6b5d08d213674660ed2dc5))
* **api:** update composite API spec ([bcad6e6](https://github.com/cloudflare/terraform-provider-cloudflare/commit/bcad6e616ce4ad8e886607f3bcadd3a5062b50d5))
* **api:** update composite API spec ([92336fa](https://github.com/cloudflare/terraform-provider-cloudflare/commit/92336fac92a99144c9d34b1bb71e59d0fa097687))
* **api:** update composite API spec ([caf2088](https://github.com/cloudflare/terraform-provider-cloudflare/commit/caf20882d18a6f84779dde03caedcca73996e368))
* **api:** update composite API spec ([5da6b11](https://github.com/cloudflare/terraform-provider-cloudflare/commit/5da6b11f1507aa43c6d5738267daf578c4cf875b))
* **api:** update composite API spec ([f4d6ea3](https://github.com/cloudflare/terraform-provider-cloudflare/commit/f4d6ea3895f30b7447418e3c58850c47a7058f7f))
* **api:** update composite API spec ([9a311d4](https://github.com/cloudflare/terraform-provider-cloudflare/commit/9a311d4fb151a43a265b94df99aba8c19cc1e413))
* **api:** update composite API spec ([c168606](https://github.com/cloudflare/terraform-provider-cloudflare/commit/c168606348f559292178d30d1a6baedf60cbf231))
* **api:** update composite API spec ([81ae3c0](https://github.com/cloudflare/terraform-provider-cloudflare/commit/81ae3c018fa8e7eae8cb7f07409c49139d449dca))
* **api:** update composite API spec ([7e89e06](https://github.com/cloudflare/terraform-provider-cloudflare/commit/7e89e06d993000a2adb7be86dd767dc1f60ac06f))
* **api:** update composite API spec ([d8a8588](https://github.com/cloudflare/terraform-provider-cloudflare/commit/d8a8588875874bd261315636b9fc7c93ef0f733e))
* **api:** update composite API spec ([74db801](https://github.com/cloudflare/terraform-provider-cloudflare/commit/74db801baaa0ff3f7f69169300825a095a945e14))
* **api:** update composite API spec ([cd59d8f](https://github.com/cloudflare/terraform-provider-cloudflare/commit/cd59d8f485d32ffeffd4e1b48fa2aec7e4081a4d))
* **api:** update composite API spec ([1f2d3ea](https://github.com/cloudflare/terraform-provider-cloudflare/commit/1f2d3ea746c52ceaf4c2700b5d6946ada217c0da))
* **api:** update composite API spec ([3257a0e](https://github.com/cloudflare/terraform-provider-cloudflare/commit/3257a0ef2f81efb0ec2daca23d102930f5383940))
* **api:** update composite API spec ([c7020a9](https://github.com/cloudflare/terraform-provider-cloudflare/commit/c7020a97c3b37771d65d58fb1717be25dfbd1632))
* **api:** update composite API spec ([f309dd5](https://github.com/cloudflare/terraform-provider-cloudflare/commit/f309dd56f980a10ea25c3a591f8b5e5153b0f5a8))
* **api:** update composite API spec ([7e8a1d2](https://github.com/cloudflare/terraform-provider-cloudflare/commit/7e8a1d204073f2fe4e94256594410a293fd2745f))
* **api:** update composite API spec ([4256a79](https://github.com/cloudflare/terraform-provider-cloudflare/commit/4256a79d5961c1a3952adf0315d67723f8cbb702))
* **api:** update composite API spec ([60556d0](https://github.com/cloudflare/terraform-provider-cloudflare/commit/60556d0c9075a52a098341a2fe289a01792c34c8))
* **api:** update composite API spec ([b773b99](https://github.com/cloudflare/terraform-provider-cloudflare/commit/b773b99387177e8fbbf5e497d9b4208458b25770))
* **api:** update composite API spec ([ce5f139](https://github.com/cloudflare/terraform-provider-cloudflare/commit/ce5f13991ae6d17840deabe97e9c99e813eacc00))
* **api:** update composite API spec ([e389f48](https://github.com/cloudflare/terraform-provider-cloudflare/commit/e389f48619c29b53922182cf519e9a5b9bb67f2e))
* **api:** update composite API spec ([93649a2](https://github.com/cloudflare/terraform-provider-cloudflare/commit/93649a2753419364731e51d38e60fda2acb5afec))
* **api:** update composite API spec ([e82f6fa](https://github.com/cloudflare/terraform-provider-cloudflare/commit/e82f6fa2c31f6261c0eca79961ab02fbe4c3b04a))
* **api:** update composite API spec ([beda797](https://github.com/cloudflare/terraform-provider-cloudflare/commit/beda7975d69a3930b8a9972800dea2456734513a))
* **api:** update composite API spec ([5dd98ee](https://github.com/cloudflare/terraform-provider-cloudflare/commit/5dd98ee5920ce502847f0e17862893a26cfc82af))
* **api:** update composite API spec ([baee58d](https://github.com/cloudflare/terraform-provider-cloudflare/commit/baee58d924157f7dda7b2e808b744e0444423d3e))
* **api:** update composite API spec ([dce8c50](https://github.com/cloudflare/terraform-provider-cloudflare/commit/dce8c50b34c4e4e0282dbc4dbf8fa3ca4c42d932))
* **api:** update composite API spec ([e4975cf](https://github.com/cloudflare/terraform-provider-cloudflare/commit/e4975cf7b7b227f14cdb1ecd9a90ef9114f9adfb))
* **api:** update composite API spec ([033400e](https://github.com/cloudflare/terraform-provider-cloudflare/commit/033400ec2fcf3250bb9541b71811e4173dd3c08e))
* **api:** update composite API spec ([45e5e32](https://github.com/cloudflare/terraform-provider-cloudflare/commit/45e5e32998e8c5ec7ef6f79c72e6d1fe6b4d4bd2))
* **api:** update composite API spec ([0ae9f2d](https://github.com/cloudflare/terraform-provider-cloudflare/commit/0ae9f2d69d1654add2a2eec7ba2afb44ac1c0eb5))
* **api:** update composite API spec ([8840f72](https://github.com/cloudflare/terraform-provider-cloudflare/commit/8840f725a15855d41272bea2c945bbfb6b7a5d03))
* **api:** update composite API spec ([050db19](https://github.com/cloudflare/terraform-provider-cloudflare/commit/050db19c1381d3ba77e9914ba2fee0131615df3b))
* **api:** update composite API spec ([502c8e9](https://github.com/cloudflare/terraform-provider-cloudflare/commit/502c8e99f7d4f37f8206a6a54df80f21201a2623))
* **api:** update composite API spec ([432ca86](https://github.com/cloudflare/terraform-provider-cloudflare/commit/432ca86bb4a731efc1c63d1fb7b0a2db05576558))
* **cloudflare_certificate_pack:** docs show safe rotation instructions ([#6388](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6388)) ([8bc17d5](https://github.com/cloudflare/terraform-provider-cloudflare/commit/8bc17d5b68c6bd50f6155349dbfd8ed5e02806c0))
* include new sections for pr template ([#6395](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6395)) ([4a88b23](https://github.com/cloudflare/terraform-provider-cloudflare/commit/4a88b2385ae6d11160d1f14d0d6208b85ff83fcb))
* increase legacy migrator test coverage ([#6401](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6401)) ([1952b3e](https://github.com/cloudflare/terraform-provider-cloudflare/commit/1952b3eeabd0f2772328f4185360339f9938be3d))
* **internal:** codegen related update ([ca48f40](https://github.com/cloudflare/terraform-provider-cloudflare/commit/ca48f4022af0bca94bdd57bb2cac30011026d3f6))
* **internal:** codegen related update ([f84555c](https://github.com/cloudflare/terraform-provider-cloudflare/commit/f84555cad30b97a06a9c6691773147b1ec6c7e69))
* **internal:** codegen related update ([b3695a6](https://github.com/cloudflare/terraform-provider-cloudflare/commit/b3695a6e407b8ed98cceb55fcc0678dc067e5adb))
* **internal:** codegen related update ([cc52601](https://github.com/cloudflare/terraform-provider-cloudflare/commit/cc526016d504aaccbf4fdba3b8cfaf13d36657b7))
* **internal:** codegen related update ([051073a](https://github.com/cloudflare/terraform-provider-cloudflare/commit/051073a86b176f2110c34684e26635bd9186896f))
* **internal:** codegen related update ([431ccb9](https://github.com/cloudflare/terraform-provider-cloudflare/commit/431ccb9536095c9e535c6db50fdc6dd38e1729c6))
* **internal:** codegen related update ([0e08a17](https://github.com/cloudflare/terraform-provider-cloudflare/commit/0e08a177d62e4ad451d5e6ec40e90154e9dccee3))
* **internal:** codegen related update ([678bfe0](https://github.com/cloudflare/terraform-provider-cloudflare/commit/678bfe0d31581df71fe0834843600616a79149ab))
* **internal:** codegen related update ([bbd5165](https://github.com/cloudflare/terraform-provider-cloudflare/commit/bbd5165de7ebf042ca476021c4e8e9913fb547d4))
* **internal:** codegen related update ([48f2511](https://github.com/cloudflare/terraform-provider-cloudflare/commit/48f2511f570e5d2f3a1b9066510a755d81c9bfcb))
* **internal:** codegen related update ([b3960a5](https://github.com/cloudflare/terraform-provider-cloudflare/commit/b3960a533d02018b06768e2d1b8507f90bf58944))
* **zones:** data source tests ([#6414](https://github.com/cloudflare/terraform-provider-cloudflare/issues/6414)) ([7726af3](https://github.com/cloudflare/terraform-provider-cloudflare/commit/7726af35dfb3e7650448bde16b07b09ddea86efe))
